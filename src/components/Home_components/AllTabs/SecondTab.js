    ...
    return (
      <div className="SecondTab">
        <div className="n01">
          ...
          <Link to="/cncr/i01" className="name">CNCR01</Link>
          <p id="status-off"><span class="dot-grey"></span> Không hoạt động</p>
        </div>
        <div className="n02">
          <img src="https://yourclubhire.com/public/img/testimonios_avatar.png" class="avt" alt="avt"/>
          <FiMessageSquare className="mess-icon"></FiMessageSquare>
          <Link to="/cncr/i02" className="name">CNCR02</Link>
          <p id="status-off"><span class="dot-grey"></span> Không hoạt động</p>
        </div>
        <div className="n03">
          <img src="https://yourclubhire.com/public/img/testimonios_avatar.png" class="avt" alt="avt"/>
          <FiMessageSquare className="mess-icon"></FiMessageSquare>
          <Link to="/cncr/i03" className="name">CNCR03</Link>
          <p id="status-onl"><span class="dot-green"></span> Hoạt động</p>
        </div>
        <div className="n04">
          <img src="https://yourclubhire.com/public/img/testimonios_avatar.png" class="avt" alt="avt"/>
          <FiMessageSquare className="mess-icon"></FiMessageSquare>
          <Link to="/cncr/i04" className="name">CNCR04</Link>
